     ...
     <div className={styles.section_about_us}>
                    <div>
                        <div className={styles.text_1}>
                            <h4 className={styles.h4}>What they say about us</h4></div>
                          <div className={styles.about_us_profile_img_box}>
                            <img className={styles.about_us_profile_img}
                              src="imgs/photo6.jpg" alt="photo" 
                              width={75} 
                              height={75} />
                           </div>
                         <div className={styles.feature_text_box}>
                    <p className={styles.feature_text}>late heips you see how many days you need to work to reach your final goal</p></div>
                    <div className={styles.feature_text_box}>
                    <p className={styles.feature_text}>Regina Miles</p></div>
                    <div className={styles.learn_more}>
                    <h5 className={styles.h3}>Designer</h5></div>
                </div>
