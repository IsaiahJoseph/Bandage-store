...
<div>
        ...
        <div>
            <button className={styles.button_load_more}>LOAD MORE PRODUCTS</button>
        </div>
        ...
        <div className={styles.service_flex} >
               ...
               <div className={styles.service_labels}>
                ...
                <div className={styles.service_category_box}>
                    <p className={styles.service_category}>Get your best looking smile now!</p>
                </div>
                </div>
            </li>
            ...
            <li >
               ...
               <div className={styles.service_labels}>
                ...
                <div className={styles.service_category_box}>
                    <p className={styles.service_category}>Defalcate is most focus in helping your most beatiful smile</p>
                </div>
                </div>
            </li>
            ...
            <li >
               ...
               <div className={styles.service_labels}>
                ...
                <div className={styles.service_category_box}>
                    <p className={styles.service_category}>Overcome any hurdle or any other problem</p>
                </div>
                </div>
            </li>
